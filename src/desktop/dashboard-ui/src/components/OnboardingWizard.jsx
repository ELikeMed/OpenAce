...
const AI_PROVIDERS = {
  ...
  kimi: {
    ...
    desc: 'Frontier-tier open model — cheapest API at $3/$15 per million tokens',
    icon: '🌙',
    needsKey: true,
    keyPlaceholder: 'sk-...',
    models: ['kimi-k3', 'moonshot-v1-auto'],
    color: '#8B5CF6',
    helpText: 'Get an API key from the Kimi platform',
  ...
  ollama: {
    ...
    icon: '🦙',
    needsKey: false,
    models: ['qwen2.5', 'llama3.1', 'mistral', 'hermes3', 'gemma2'],
    color: '#10b981',
    helpText: 'Download and run Ollama on your machine — no API key needed. Use qwen2.5 or llama3.1 for tool calling.',
